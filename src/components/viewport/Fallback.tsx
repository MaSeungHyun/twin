...
export default function Fallback() {
  ...
  return (
    <Html center sprite fullscreen>
      <div className="flex flex-col flex-1  pointer-events-none select-none text-center text-sm tracking-wide w-screen h-screen items-center justify-center gap-4 bg-white backdrop-blur-sm">
