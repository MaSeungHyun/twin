...
const panelContent =
  "scrollbar-hud relative z-[1] flex min-h-0 flex-1 flex-col overflow-x-hidden overflow-y-auto px-4 pt-[0.9rem] pb-4";
    ...
    <aside
      className={cn(
        ...
        expanded
          ...
          : wide
            ? "w-[min(32rem,calc(100vw-2.3rem))] max-[1100px]:w-[min(28rem,calc(100vw-1.5rem))] max-[720px]:w-[calc(100vw-1.5rem)]"
            : "w-[min(var(--panel-width),calc(100vw-2.3rem))] max-[1100px]:w-[min(20.5rem,calc(100vw-1.5rem))] max-[720px]:w-[calc(100vw-1.5rem)]",
      )}
      aria-label={title}
    >
